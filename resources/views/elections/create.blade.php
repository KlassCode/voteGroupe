                    ...
                    <div class="card-body">
                      <form>
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="basic-default-fullname" placeholder="Titre Election" />
                        </div>
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-company">Date Ouverture</label>
                          <input type="date" class="form-control" id="basic-default-company" placeholder="Date de debut de l'election" />
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="basic-default-company">Date Fermeture</label>
                            <input type="date" class="form-control" id="basic-default-company" placeholder="Date fermetture des votes" />
                          </div>
                        {{-- <div class="mb-3">
                        ...
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-phone">Nombre de Candidats</label>
                          <input
                            type="number"
